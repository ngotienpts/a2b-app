import { View, Text, TouchableOpacity, ScrollView, Image, Dimensions, KeyboardAvoidingView, StatusBar } from 'react-native';
...
import { fallbackImage, fetchListMyCar, fetchGetOneCategoryVehicle, fetchListCategoryVehicle, fetchUpdateMycar, fetchTurnOnDriver } from '../../api/DataFetching';
...
const MyCarComponent = () => {
    ...
    const becomeDriver = () => {
        fetchTurnOnDriver(contextToken.token)
        .then((data) => {
            if(data.res === 'success'){
